...
public class PageInterceptor implements Interceptor {
    ...
    private String convertCountSql(String sql)
    {
		...
		if(end == -1)
		{
			throw new RuntimeException("SQL语句FROM前后可能有TAB符号,请替换为空格。");
		}
		String countSql = "SELECT COUNT(1)" + sql.substring(end);
    	return countSql;
    }
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement,
        ...
        // 记录总记录数
        String countSql = convertCountSql(sql);
        ...
        try {
            ...
            int totalPage = totalCount / page.getNumPerPage() + ((totalCount % page.getNumPerPage() == 0) ? 0 : 1);
