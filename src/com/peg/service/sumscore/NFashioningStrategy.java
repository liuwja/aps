 ...
 */
public class NFashioningStrategy extends NAbstractComputeStrategy
{
	static final String ITEM_INDEX_CODE_1 = "D1";
	static final String ITEM_INDEX_CODE_2 = "D2";
	static final String ITEM_INDEX_CODE_3 = "D3";
	
	static final String ITEM_INDEX_CODE_4 = "D4";
	static final String ITEM_INDEX_CODE_5 = "D5";
	static final String ITEM_INDEX_CODE_6 = "D6";
	
	static final String ITEM_INDEX_CODE_7 = "D7";
	static final String ITEM_INDEX_CODE_8 = "D8";
	static final String ITEM_INDEX_CODE_9 = "D9";
	static final String ITEM_INDEX_CODE_10 = "D10";
	static final String ITEM_INDEX_CODE_11 = "D11";
	
	static final String ITEM_INDEX_CODE_12 = "D12";
	...
	public void compute()
	{
		...
		//喷涂退次率
		//1. 目标=<实际<=基准，D2=【ABS(实际-基准)/ABS(目标-基准)*40+60】*该指标权重；2.实际=0，D2=150*该指标权重；3.0<实际<目标，D2=MIN(目标/实际*100,150)*该指标权重；4.否则  D2=0
		...
		actualValue4 = MathUtil.divide(mesDataSum.getCol22()-mesDataSum.getCol21(), mesDataSum.getCol22(),6) ;
