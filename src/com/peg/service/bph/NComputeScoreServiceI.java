 ...
 */
public interface NComputeScoreServiceI
{
	/**
	 * 插入指标得分
	 * @param record
	 ...
	 * 项目名称如：客户质量,过程质量...
	 */
//	Map<String, Map<String,Item>> QueryItemMap();
	 ...
	 * 指标代码如：A1,A2,A3...
	 */
//	Map<String,Map<String,Index>> QueryItemIndexMap();
	/**
	 * 
...
//    Map<String,Object> QueryQPRNScore();
    ...
    /**
     * 
     * @return Map<工厂-班组,班组>月
     * @TODO:  
     */
    Map<String,Group> QueryMonthAssessment(MesDataSum mesDataSum);
