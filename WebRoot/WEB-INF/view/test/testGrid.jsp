...
$(document).ready(function(){
    ...
    var groupCols2 = [
    	{ title:'姓名', name:'name' ,width:60, align:'right' ,sortable: true},
    	{ title:'性别', name:'sex' ,width:60, align:'right' ,sortable: true},
    	{ title:'年龄', name:'age' ,width:60, align:'right' ,sortable: true}
    	];
    $('#table2').mmGrid({
        cols: groupCols2,
        url: "highcharts/exemple/testData.do",
        method: 'get',
        height: '220px'
    });
