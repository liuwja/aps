	...
	class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<tr>
			...
			<td>
		 	...
		 	<th>返工/停线单号：</th>
			<td>
				<input id="reworkGroup_reworkNumber" name="rework_number" value="" type="text" size="20" class="required" readonly="true" />
				<input id="reworkGroup_reworkId" name="rework_id" value="" type="hidden" size="20" readonly="true" />
		...
		<th>责任部门：</th>
		    <td>
		       <input type="text" id="duty_depart" name="duty_depart" size="20" />
		    </td>	
		<th>责任比例：</th>
		    <td >
		         <input type="text"  id="duty_proportion"  name="duty_proportion" size="20" />
		    </td>
		</tr>
		<tr>
			<th>原因：</th>
			<td colspan="3" style="padding-bottom: 5px;padding-top: 5px"><textarea name="rework_reason" id="rework_reason" cols="70"></textarea></td>
		</tr>
		<th>实际返工数：</th>
		    <td>
		       <input type="text" id="rework_count" name="rework_count" size="20" />
			</td>	
		<th>产品线：</th>
			<td>
