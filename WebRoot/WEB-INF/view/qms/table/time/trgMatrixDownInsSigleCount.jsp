...
<div class="pageHeader" style="position:static">
	<form onsubmit="return navTabSearch(this);" id="trgDownMatrixReTotalCount" rel="pagerForm" action="timeMatrixInstall/trgMatrixDownInsSigleCount.do" method="post">
	<div class="searchBar">
		<table class="searchContent">
			<tr>
                <td style="text-align: center; width: 60px">机型类别：</td>
                <td style="width: 80px">
					<select name="productType" onchange="loadProductData('#prodFamilyTmdList', '#trginsCpartTypeDownList');">
                ...
                <td style="width: 120px">
                	<div id="prodFamilyTmdList" class="dropdownlist"></div>
                </td>
    			...
    			<td>
					...
					<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="checkinscdSigleCount();">查找</button></div></div>
    			</td>
    			<td>
    				<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="getDataSourceByMenuName('市场质量统计分析', '具体分析', '安装时间序列分析(倒三角)', '三角阵');">数据来源</button></div></div>
    			</td>
			</tr>
			<tr>
				...
				<td>
					<div id="trginsCpartTypeDownList" class="dropdownlist"></div>
				</td>
				...
				<td>
					...
					<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="exportExcelByCommon('timeMatrixInstall/excelOutput_trgDownInsSigleCount.do', '#trgDownMatrixReTotalCount');">导出</button></div></div>
				</td>
    		</tr>
    		<tr>
				...
				<td>
					...
					<div id="trginsCountRegionDownList" class="dropdownlist"></div>
				</td>
...
<script type="text/javascript">
	$(function(){
		loadProductFamilyData("#prodFamilyTmdList", "productFamilyTxt", [${vo.productFamilyTxt}], ${jsonProFamily});
   		loadProductTypeData("#trginsCpartTypeDownList", "partTypeListTxt", [${vo.partTypeListTxt}], ${jsonParts});
   		loadRegionData("#trginsCountRegionDownList", "regionListTxt", [${vo.regionListTxt}], ${jsonRegions});
	});
       
	var tmsdFixwidth = $(".pageContent", navTab.getCurrentPanel()).width()-16;
	$("#fixTable",navTab.getCurrentPanel()).attr("width",tmsdFixwidth-26);
