...
function loadTimeChart() {
	...
	var url = "<c:url value='timeChart/getTimeInfo.do'/>";
	$.post(url, {productType:productType,queryMonth:queryMonth}, function(data) {

		if (data.result == 0) {
			showChart("timeChart", data.chartsInfo);
		} else {
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				...
				<td>
					<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="loadTimeChart();">查找</button></div></div>
				</td>				
			</tr>
		</table>
	</div>
...
<div class="pageContent">
		...
		<div id="timeChart" class="singleChartDiv">
</div>