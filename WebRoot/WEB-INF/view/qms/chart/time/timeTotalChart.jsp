...
function loadTimeTotalChart() {
	...
	var url = "<c:url value='timeChart/getTimeTotalInfo.do'/>";
	$.post(url, {productType:productType,queryMonth:queryMonth}, function(data) {

		if (data.result == 0) {
			showChart("timeTotalChart", data.chartsInfo);
		} else {
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				...
				<td>
					<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="loadTimeTotalChart();">查找</button></div></div>
				</td>				
			</tr>
		</table>
	</div>
...
<div class="pageContent">
		...
		<div id="timeTotalChart" class="singleChartDiv">
</div>