...
jQuery(document).ready(function(){
	$("#detailAnalyDiv").hide();
	setTimeout("loadDetailAnalyChart()",50);
});

function loadDetailAnalyChart() {
	...
	$.post(url, jsonVar, function(data) {
		...
		if (data.result == 0) {
			showChart("detailAnalyDiv", data.chartsInfo);
...
<div class="pageHeader" id="detailAnalyDiv">
...
<div class="pageContent">
		<div id="detailChart" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
</div>