	...
	class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<table class="tableFormContent nowrap">
			...
			<tr>   
			    <th>部门名称</th>
			    <td >
			         <input type="text"   name="departmentName" size="20" class="required" value="${vo.departmentName }" />
			    </td>
			</tr>
			<tr>
			    <th>部门编码</th>
			    <td >
			         <input type="text"   name="departmentNumber" size="20" class="required" value="${vo.departmentNumber }"/>
			    </td>
			</tr>
		</table>
		</div>
