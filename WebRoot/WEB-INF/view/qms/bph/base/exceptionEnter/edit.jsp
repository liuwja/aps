...
<div class="pageContent">
	<form method="post" id="formID" action="<c:url value='system/exceptionEnter/update.do?navTabId=exceptionEnterNav&callbackType=closeCurrent'/>" 
	class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<tr>   	  
		    ...
		    <td colspan="3">
		       <input type="text" name="exceptionType" size="20"  class="required" value="${vo.exceptionType }">
		    </td>
		</tr>
		<tr>
		    <td style="background: #F7F9FC;">异常内容:</td>
		    <td colspan="3">
		       <textarea  name="exceptionName"  cols="80"  rows="2" class="required" >${vo.exceptionName }</textarea>
		    </td>
		</tr>
		<tr>   
		    ...
		    <td colspan="3">
		        <input type="text" id="startTime" value="<fmt:formatDate value='${vo.occurTime}' type='date' pattern='yyyy-MM-dd'/>" name="startTime" placeholder="请输入日期" onclick="laydate()"  readonly="true" class="required"/>
		    </td>	
		</tr>
		</table>
		</div>
