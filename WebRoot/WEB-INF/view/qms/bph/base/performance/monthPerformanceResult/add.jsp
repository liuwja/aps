...
<div class="pageContent">
	<form method="post" id="formID" action="<c:url value='ptm/monthPerformanceResult/add.do?navTabId=monthPerformanceResultlistNav&callbackType=closeCurrent'/>" 
...
<tbody id="printConfigsList">
  <c:forEach items="${vo.monthList }" var="voo" varStatus="vs">
    <tr id='newArray'>
       <td>
       		<input width="50" type="checkbox" id="toAdd" name="toAdd" value="${ voo.id }"/>
       ...
       <%-- <td width="" style="width:20px;text-align:center;"><input type="text" id="" name="item[${vs.index }].column2" value="${ voo.column2 }"  class="required"/></td>	 --%>       
		...
		<div class="formBar">
			<ul>
				<li><div class="buttonActive"><div class="buttonContent"><button type="button" onclick="checkRepeat()">新增</button></div></div></li>
				<li>
