...
<div class="pageContent">
	<form method="post" id="formID" action="<c:url value='ptm/monthPerformanceResult/deleteMonthIndexResult.do?navTabId=monthPerformanceResultlistNav&callbackType=closeCurrent'/>" 
