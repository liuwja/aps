...
<div class="pageContent">
	<form method="post" id="formID" action="<c:url value='ptm/monthPerformanceSet/delete.do?navTabId=monthPerformancelistNav&callbackType=closeCurrent'/>" 
...
<tbody id="printConfigsList">
  <c:forEach items="${vo.monthList }" var="voo" varStatus="vs">
    <tr id='newArray'>
       ...
       <input type="text" id="myMonth"  name="item[${vs.index }].myMonth" placeholder="请输入日期" onclick="laydate({isym:true, format: 'YYYY-MM'})" value="<fmt:formatDate value='${voo.myMonth}' pattern='yyyy-MM'/>" readonly="true"/>
       </td>
