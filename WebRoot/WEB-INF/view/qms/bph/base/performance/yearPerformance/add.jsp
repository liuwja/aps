...
<div class="pageContent">
	<form method="post" id="formID" action="<c:url value='ptm/yearPerformanceSet/save.do?navTabId=yearPerformancelistNav&callbackType=closeCurrent'/>" 
	class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<tr>
		    ...
		    <th>年度</th>
		    <td >
		         <input type="text" id="checkYear"  name="checkYear" value="<fmt:formatDate value='${vo.checkYear}' pattern='yyyy'/>" size="20" class="required" readonly="readonly"/>
		    </td>
		</tr>
		<tr>   
			<th>绩效目标大类</th>
