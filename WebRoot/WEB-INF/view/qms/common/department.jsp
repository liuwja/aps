...
<input type="hidden" id="fcategory_${id_end}" value="${param.department }">
<input type="hidden" id="fgroup_${id_end}" value="${param.targetclass }">
<input type="hidden" id="fagroup_${id_end}" value="${param.indexcontent }">
<c:if test="${param.dispalyType eq 'doubleLine'}">
<tr>
</c:if>				
				<c:if test="${param.department eq '1'}">
