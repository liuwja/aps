...
<%-- 待选择列表  开始--%>
	<div style="float: left;width: 65%;border: 1px solid #ededed;" id="toSelectSupplierList">
...
<!-- 			               
			               ...
			               <td>
			                 <input type="text" name="supplierClass" id="supplierClass" size="10" value="${supplierClass}"/>
			               </td>
			          </tr>
			          <tr>
   -->
