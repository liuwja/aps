...
<div class="pageHeader" style="position:static">
	<form id="onlinetwo" onsubmit="return navTabSearch(this);" rel="pagerForm" action="base/quality/onlinebatch.do" method="post">
...
<script type="text/javascript">
	...
	/*$(function(){
		var result=${result};
		if(result==-1){
			clearComSupplierAll('supplierLookup${id_end}');
		}
	})*/
</script>