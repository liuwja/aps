		...
		<table class="searchContent tableF">
    		...
    		<tr> 			
				<td>
					...
					<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="sumMesDataMon('base/online/onlineReplaceSumDataMonth.do');">MES更换数据月份汇总</button></div></div>
					</shiro:hasPermission>
				</td>
				<td class="explain">
			...
			<tr> 			
				<td >
					...
					<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="sumMesDataDay('base/online/onlineReplaceSumDataDay.do');">MES更换数据单日汇总</button></div></div>
					</shiro:hasPermission>
				</td>
				<td class="explain">
