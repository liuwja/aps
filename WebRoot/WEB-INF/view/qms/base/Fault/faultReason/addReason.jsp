...
<div class="pageContent">
	<form method="post" id="formID" action="<c:url value='base/fault/faultReason/saveFaultReason.do?navTabId=faultReasonNav&callbackType=closeCurrent'/>" 
		...
		<table class="tableFormContent nowrap">
			...
			<tr>
				...
				<td>
	                ...
	                <select id="valid" name="valid" style="width: 210px; ">
