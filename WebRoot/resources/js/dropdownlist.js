 ...
 */
(function($){
	$.fn.qmsdropdownlist=function(opts){
		var settings = {
						id:'',
						width:100,
						listboxwidth:0,
		...
		return this.each(function(){
			...
			var listbox = $('<div>',{
							...
							'html':'<div class="ddl-content-list" style="width: '+settings.listboxwidth+'; overflow-y: auto; overflow-x: hidden; z-index: 1000;"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="line-height:15px;"><tbody></tbody></table></div>',
			...
			objid.init = function(mdata,selectedValue){
				...
				{
					$('div.ddl-content-list',$this).height(settings.listboxmaxheight-30);
