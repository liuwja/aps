...
//		console.log("boxHtml = " + boxHtml);
		$(boxHtml).appendTo("body").css({top:-$(this._boxId).height()+"px"}).animate({top:"25%"}, 500);//提示框移到屏幕中间
...
//		console.log("jButs = " + jButs);
//		console.log("jCallButs = " + jCallButs);
//		console.log("jDoc = " + jDoc);
		
		for (var i = 0; i < buttons.length; i++) {
//			console.log("buttons[i].call = " + buttons[i].call);
//			console.log("buttons[i].keyCode = " + buttons[i].keyCode);
//			console.log("target:jButs.eq(i) = " + {target:jButs.eq(i)});
//			console.log("this._keydownOk = " + this._keydownOk);
//			console.log("this._keydownEsc = " +  this._keydownEsc);
