...
var DWZ = {
	...
	pageInfo: {pageNum:"pageNum", numPerPage:"numPerPage", direction:"direction",orderField:"orderField", orderDirection:"orderDirection"},
	...
	ajaxError:function(xhr, ajaxOptions, thrownError){
		if (alertMsg) {
			if(xhr.statusText == 'error' && xhr.responseText == '')
			{
				alertMsg.error("<div>服务可能已经停止或者网络中断</div>");
			}
			else
			{
