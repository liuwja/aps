	...
	$.fn.navMenu = function(){
		return this.each(function(){
			...
			$box.find("li>a").click(function(){
				...
				var tcollapse_div = $("#sidebar .toggleCollapse div");
				if(tcollapse_div.is(":visible"))
				{
					tcollapse_div.trigger("click");
				}
				//alert(aaa);
				navTab.openTab($a.attr("rel"), $a.attr("href"),{title:$a.attr("title")});
				return false;
			});
		});
	}
