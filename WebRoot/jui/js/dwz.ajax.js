...
function _getPagerForm($parent, args) {
	...
	if (form) {
		...
		if (args["direction"]) form[DWZ.pageInfo.direction].value = args["direction"];
...
function dwzPageBreak(options){
	var op = $.extend({ targetType:"navTab", rel:"", data:{pageNum:"", numPerPage:"", direction:"", orderField:"", orderDirection:""}, callback:null}, options);
